      ...
      <div className="bg-white py-6 sm:py-8 lg:py-12">
          <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
              <div className="flex flex-col items-center">
                  ...
                  <Link to="/" className="mb-8 inline-flex items-center gap-2.5 text-2xl font-bold text-black md:text-3xl" aria-label="logo">
                  ...
                  <p className="mb-4 text-sm font-semibold uppercase text-indigo-500 md:text-base">That’s Link 404</p>
                  <h1 className="mb-2 text-center text-2xl font-bold text-gray-800 md:text-3xl">Page not found</h1>

                  <p className="mb-12 max-w-screen-md text-center text-gray-500 md:text-lg">La Página que Buscas no Existe.</p>
                  <p className="mb-12 max-w-screen-md text-center text-gray-500 md:text-lg">{error}</p>
